...
export function SettingsPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      {success && (
        <div className="p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 font-semibold text-xs flex items-center gap-2">
      ...
      <form
        onSubmit={handleSave}
        className="p-6 sm:p-8 rounded-2xl bg-bg-card border border-bg-border space-y-6"
      >
        <div>
          ...
          <textarea
            ...
            className="w-full bg-bg-surface border border-bg-border rounded-xl px-3.5 py-2.5 text-sm text-text-primary focus:outline-none focus:border-brand-primary"
          />
        </div>
        ...
        <div className="space-y-4 pt-4 border-t border-bg-border/60">
          ...
          <div className="flex items-center justify-between p-3.5 rounded-xl bg-bg-surface border border-bg-border">
            <div>
              <div className="text-xs font-bold text-white">Public RPG Profile</div>
          ...
          <div className="flex items-center justify-between p-3.5 rounded-xl bg-bg-surface border border-bg-border">
            <div>
              <div className="text-xs font-bold text-white">Opt-Out of Global Leaderboards</div>
              <div className="text-[11px] text-text-muted">
